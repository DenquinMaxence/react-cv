...
export const SkillsData = {
	languages_frameworks: [
		...
		{
			title: 'Bootstrap',
			icon: <box-icon name='bootstrap' type='logo' size='lg' color='#553b7c' />,
			width: '100%',
		},
		{
			title: 'Symfony 4',
	...
	tools: [
		...
		{
			title: 'WampServer',
			icon: <img src={LogoWampServer} alt='logo-wampserver' width='48px;' height='48px;' />,
			width: '100%',
		},
		{
			title: 'HeidiSQL',
